...
// total price 
  ...
  useEffect(()=>{
    const totalprices=result.reduce((accu,cuurent)=>{
      ...
      return(
        accu+cuurent.item.priceAfterDiscount*cuurent.count
      )
    },0)
          ...
          <div class="container mt-5">
                    ...
                    <div class="row justify-content-center my-5 ">
                      <div className="copone col-md-6 px-4">
                          <form action="" className='row totalprices mb-4' onSubmit={(e)=>{
                            applaycopone(e)
                          }}>
                            <h2 class=" mb-3  text-capitalize">applay copone</h2>
                            <input type="text" value={coponevalue} className='mt-2 rounded-5 col-lg-6 me-1 py-1' onChange={(e)=>{
                        ...
                        <div class="col-lg-5 col-md-6 totalprices">
                            ...
                            <button className=' border-0  text-center me-auto   d-block go_to_card_button go_to_card_button3 py-4 px-4 mt-2  text-uppercase' onClick={(e)=>{
                              gocheckout(e)
                            }} >
                               PROCEED TO CHECKOUT
                        </button>
