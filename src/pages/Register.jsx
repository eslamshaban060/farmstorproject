    ...
    <div className="register">
      <div className="register_container">
        ...
        <div className="container-md formcontiner w-100 p-5 mb-5 pb-5 ">
          <form
            className="mt-5 mx-auto p-5 rounded-3 mb-5 "
          ...
          >
            ...
            <div className="row gap-md-2 gap-4">
              ...
              <div className="col-9">
                <p className="fs-5 fw-medium ">Sign Up</p>
            ...
            <div className="mb-3">
              ...
              <input
                type="text"
                className="w-100 rounded-2 px-3 pt-3 pb-3 border-0 bg-white "
            ...
            <div className="mb-3">
              ...
              <input
                type="email"
                className="w-100 rounded-2 px-3 pt-3 pb-3 border-0  ps-5"
                ref={emailref}
            ...
            {/* --------------------- Submit button -------------------- */}
            <button type="submit" className="btn text-white w-100 pt-3 pb-3">
              Submit
            </button>
          </form>
        </div>
